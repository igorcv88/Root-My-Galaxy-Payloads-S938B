...
enum czg3_race_role { CZG3_RACE_PARENT, CZG3_RACE_OWNER, CZG3_RACE_WAITER,
                      CZG3_RACE_CONSUMER, CZG3_RACE_ROLE_COUNT };
enum czg3_race_event {
  CZG3_RACE_THREAD_READY, CZG3_RACE_PSELECT_PREPARE_COMPLETE,
  CZG3_RACE_PSELECT_ENTER, CZG3_RACE_PSELECT_RETURN,
  CZG3_RACE_OWNER_TARGET_LOCKED, CZG3_RACE_OWNER_CHAIN_LOCK_ENTER,
  CZG3_RACE_OWNER_CHAIN_LOCK_RETURN, CZG3_RACE_CMP_ENTER,
  CZG3_RACE_CMP_RETURN, CZG3_RACE_WAIT_REQUEUE_ENTER,
  CZG3_RACE_WAIT_REQUEUE_RETURN, CZG3_RACE_WAITER_TIMEOUT_ACCEPTED,
  CZG3_RACE_WAITER_UNLOCK_ENTER, CZG3_RACE_WAITER_UNLOCK_RETURN,
  CZG3_RACE_WRITER_ENTER, CZG3_RACE_WRITER_RETURN,
  CZG3_RACE_CONSUMER_ARMED, CZG3_RACE_DELAY_BEGIN, CZG3_RACE_DELAY_END,
  CZG3_RACE_CONSUMER_ACTION_BEGIN, CZG3_RACE_READINESS_OPERATION_COMPLETE,
